...
import {IUniswapV3SwapCallback} from "../../../libraries/IUniswapV3SwapCallback.sol";
...
abstract contract V3SwapRouter is Payments, IUniswapV3SwapCallback {
    ...
    function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
        ...
        if (isExactInput) {
            ...
            if (path.hasMultiplePools()) {
                ...
                pay(tokenOut, payer, msg.sender, amountToPay);
            }
        }
    }
